...
list my_struct_list: MyStruct;

function main() {
    // Test basic struct field access
    add(MyStruct { name: "Alice", date: "01/01/2026" }, my_struct_list);
    add(MyStruct { name: "Bob", date: "02/02/2026" }, my_struct_list);
    add(MyStruct { name: "Charlie", date: "03/03/2026" }, my_struct_list);
